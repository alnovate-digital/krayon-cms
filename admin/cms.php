    ...
    class KConn{
        ...
        static function invoke( $ignore_level=0 ){
            ...
            if( $AUTH->user->access_level >= K_ACCESS_LEVEL_SUPERUSER ){
                ...
                $DB->update( K_TBL_SETTINGS, array('k_value'=>K_ENGINE_VERSION), "k_key='k_engine_version'" );
            }
            ...
            if( $PAGE->error ){
                ...
                if( $AUTH->user->access_level >= K_ACCESS_LEVEL_SUPERUSER ) $DB->commit( 1 );
            ...
            if( strpos($content_type_header, 'html')!==false ){
                ...
                if( defined('K_IS_MY_TEST_ENGINE') ){
                    $html .= "\n<!-- in: ".k_timer_stop()." -->\n";
                    $html .= "\n<!-- Queries: ".$DB->queries." -->\n";
                }
            }
