<?php
    ...
    function k_register_admin_routes(){
        ...
        if( count($rs) ){
            foreach( $rs as $tpl ){
                ...
                $default_routes['list_view'] = array(
                    'path'=>'list',
                    'include_file'=>K_ENGINE_DIR.'edit-pages.php',
                ...
                if( $tpl['dynamic_folders'] ){
                    $default_routes['folder_list_view'] = array(
                        'path'=>'list_folders',
                        'include_file'=>K_ENGINE_DIR.'edit-folders.php',
        ...
        $default_routes['list_view'] = array(
            'path'=>'list',
            'include_file'=>K_ENGINE_DIR.'edit-drafts.php',
            'class'=> 'KDraftsAdmin',
            'action'=>'list_action',
        ...
        $default_routes['list_view'] = array(
            'path'=>'list',
            'include_file'=>K_ENGINE_DIR.'edit-users.php',
            'class'=> 'KUsersAdmin',
            'action'=>'list_action',
        ...
        $default_routes['list_view'] = array(
            'path'=>'list',
            'include_file'=>K_ENGINE_DIR.'edit-comments.php',
            ...
            foreach( $rs as $tpl ){
                ...
                $FUNCS->register_admin_menuitem(
                    array(
                        'name'=>$tpl['name'],
                        'title'=>$tpl['title'],
                        'desc'=>($AUTH->user->access_level >= K_ACCESS_LEVEL_SUPERUSER) ? $tpl['name'] : '',
                        'weight'=>$tpl['k_order'],
                        'parent'=>$parent,
    ...
    function k_add_render_vars(){
        ...
        $vars = array();
        $vars['k_cms_version'] = K_ENGINE_VERSION;
        $vars['k_cms_build'] = K_ENGINE_BUILD;
        ...
        $vars['k_admin_path'] = K_ENGINE_DIR;
    ...
    function _render_logo( $dark=0, $href='', $id='', $class='' ){
        ...
        if( K_PAID_LICENSE ){
            if( $dark ){
                $logo_src = ( defined('K_LOGO_DARK') ) ? K_ADMIN_URL.'theme/images/'.K_LOGO_DARK : K_SYSTEM_THEME_URL.'includes/admin/images/logo_dark.png';
            }
            else{
                $logo_src = ( defined('K_LOGO_DARK') ) ? K_ADMIN_URL.'theme/images/'.K_LOGO_LIGHT : K_SYSTEM_THEME_URL.'includes/admin/images/logo_light.png';
            }
        }
        else{
            $logo_src = ( $dark ) ? K_SYSTEM_THEME_URL.'includes/admin/images/logo_dark.png' : K_SYSTEM_THEME_URL.'includes/admin/images/logo_light.png';
        }
    ...
    function k_spl_template_handler( $id, $name, &$mode, $masterpage ){
        ...
        elseif( $masterpage=='comments' ){
            ...
            if( $mode=='edit' || $mode=='delete' ){
                require_once( K_ENGINE_DIR.'comment.php' );
