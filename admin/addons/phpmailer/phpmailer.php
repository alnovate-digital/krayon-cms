<?php
    ...
    class KPHPMailer{
        ...
        function populate_config(){
            $cfg = array();
            if( file_exists(K_ENGINE_DIR.'addons/phpmailer/config.php') ){
                require_once( K_ENGINE_DIR.'addons/phpmailer/config.php' );
            }
        ...
        function send_mail_handler( &$from, &$to, &$subject, &$text, &$headers, &$result, &$arr_config, $debug ){
            ...
            require_once( K_ENGINE_DIR.'addons/phpmailer/PHPMailer/PHPMailerAutoload.php' );
            $mail = new PHPMailer;
