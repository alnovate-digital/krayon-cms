...
(function($){
  ...
  jQuery.fn.tableGear = function(options){
    ...
    setDefaults('deletePrompt', (typeof ENGINE=='object' && ENGINE.t_confirm_delete_row) ? ENGINE.t_confirm_delete_row : 'Delete this row?',  options);
    setDefaults('noDataMessage', (typeof ENGINE=='object' && ENGINE.t_no_data_message) ? ENGINE.t_no_data_message : '- No Data -',  options);
