<?php
    ...
    if( file_exists(K_ENGINE_DIR.'addons/member/member.php') ){
        require_once( K_ENGINE_DIR.'addons/member/member.php' );
    }
    ...
    if( $_rs && ($_row = mysql_fetch_row( $_rs )) ){
        ...
        require_once( K_ENGINE_DIR.'addons/votes/install.php' );
    }

    if( file_exists(K_ENGINE_DIR.'addons/votes/config.php') ){
        require_once( K_ENGINE_DIR.'addons/votes/config.php' );
    }
    ...
    class KVoteUpDown extends KUserDefinedField{
        ...
        static function register_renderables(){
            ...
            $FUNCS->register_render( 'field_vote_updown', array('template_path'=>K_ENGINE_DIR.'addons/votes/theme/', 'template_ctx_setter'=>array('KVoteUpDown', '_render_votes')) );
        }
    ...
    class KVoteStars extends KVoteUpDown{
        ...
        static function register_renderables(){
            ...
            $FUNCS->register_render( 'field_vote_stars', array('template_path'=>K_ENGINE_DIR.'addons/votes/theme/', 'template_ctx_setter'=>array('KVoteStars', '_render_votes')) );
        }
    ...
    class KVotePoll extends KVoteUpDown{
        ...
        static function register_renderables(){
            ...
            $FUNCS->register_render( 'field_vote_poll', array('template_path'=>K_ENGINE_DIR.'addons/votes/theme/', 'template_ctx_setter'=>array('KVotePoll', '_render_votes')) );
        }
