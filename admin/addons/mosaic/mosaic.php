<?php
    ...
    if( defined('K_ADMIN') ){ require_once( K_ENGINE_DIR.'addons/mosaic/gc/gc.php' ); }
    require_once( K_ENGINE_DIR.'addons/mosaic/globals/globals.php' );
    ...
    class KMosaic extends KUserDefinedField{
        ...
        static function tag_handler( $params, $node ){
            ...
            if( $AUTH->user->access_level < K_ACCESS_LEVEL_SUPERUSER || defined('K_ADMIN') ){ return; } // nop within admin panel
        ...
        static function _render_mosaic( $f, $input_name, $input_id, $extra, $dynamic_insertion ){
            ...
            foreach( $schema as $k=>$v ){
                ...
                if( $v['deleted'] && $AUTH->user->access_level >= K_ACCESS_LEVEL_SUPERUSER && defined('K_ADMIN') ){
                    $has_deleted_tile = 1;
                }
            }
