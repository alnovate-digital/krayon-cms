...
var nicEditor = bkClass.extend({
    construct: function (o) {
        ...
        bkLib.addEvent((window.ENGINE && !window.ENGINE.simple && document.getElementById('content')) ? document.getElementById('content') : document.body, 'mousedown', this.selectCheck.closureListener(this));
    },
...
var nicEditorPane = bkClass.extend({
    construct: function (elm, nicEditor, options, openButton) {
        ...
        if (window.ENGINE && !window.ENGINE.simple) {
            var windowWidth = jQuery(window).width(),
                sidebarCollapsed = document.getElementById('content').className.match(new RegExp('(\\s|^)collapsed(\\s|$)')),
        ...
        this.contain.noSelect().appendTo((window.ENGINE && !window.ENGINE.simple) ? document.getElementById('content') : document.body);
